...
## Project Structure
    ...
    ├── test_template_dev_22776  # Django project configurations
...
1. Clone this repo and `cd test_template_dev_22776`
...
2. Clone this repo and `cd test_template_dev_22776`
